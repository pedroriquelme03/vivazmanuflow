-- Estende metricas com filtros: período, colaborador, setor, local, propriedade, prioridade, evento.

DROP FUNCTION IF EXISTS public.metricas(timestamptz, timestamptz);
